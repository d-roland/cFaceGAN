...
train = EasyDict(func='util_scripts.evaluate_metrics', run_id=0, log='metric-all.txt', metrics=['swd', 'fid', 'is', 'msssim'], num_images=20000, real_passes=1); num_gpus = 1; desc = train.log.split('.')[0] + '-' + str(train.run_id)
